...
public enum ErrorDictionary {
  ...
  NO_SUCH_DEPARTMENT("10.01.09", "No such department", BUSINESS, BAD_REQUEST, NoSuchDepartmentException.class),
  NO_SUCH_PROVINCE("10.01.10", "No such province", BUSINESS, BAD_REQUEST, NoSuchProvinceException.class),
  NO_SUCH_DISTRICT("10.01.11", "No such district", BUSINESS, BAD_REQUEST, NoSuchDistrictException.class),;
